...
namespace ProjectWord.Observables.Words
{
    public class WordMetadataObservable : ViewModel
    {
        ...
        private void AddPhonetics(IPhonetic[] phonetics)
        {
        ...
        private void AddMeanings(IMeaning[] meanings)
        {
        ...
        private void AddDefinitions(IWordDefinition[] definitions, MeaningObservable meaning)
        {
